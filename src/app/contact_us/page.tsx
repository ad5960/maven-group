            ...
            <div className="flex w-full justify-center mt-10 mb-20">
                <div className="flex flex-row mx-20">
                    <div className="flex flex-col mx-10">
                        <p className="text-3xl font-bold">General Inquiries</p>
                        ...
                        <p className="text-3xl font-bold">Executive Team</p>
                        <p className="text-xl font-semibold mt-4">Chris Mavian</p>
                        <p className="flex">chris@mavengroups.com</p>
                        <p className="flex">+1 (818) 284-3389</p>
