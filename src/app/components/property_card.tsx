        ...
        <Link href={link}>
            <div className="relative w-full max-w-xs h-[250px] rounded-lg bg-slate-500 mx-auto mb-5 overflow-hidden shadow-lg sm:max-w-sm md:max-w-md lg:max-w-lg">
                <div className="relative h-3/4">
                    <Image src={imageUrl ? imageUrl : LANight} alt="Thumbnail" className="relative inset-0 h-full w-full object-cover rounded-lg transition-transform duration-300 transform hover:scale-105"
                        width={150}
                        height={150}
                    />
                    <Tag offerType={offer} />
